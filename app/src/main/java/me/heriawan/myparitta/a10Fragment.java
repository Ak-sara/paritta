 ...
 */
public class a10Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        judul.setText(R.string.a10_Judul);
        title.setText(R.string.a10_Title);
        m_man = getString(R.string.a10_man);
        m_pin = getString(R.string.a10_pin);
        m_id = getString(R.string.a10_id);
        maketext();
