...
public class a1Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        judul.setText(R.string.a1_Judul);
        title.setText(R.string.a1_Title);
        m_man = getString(R.string.a1_man);
        m_pin = getString(R.string.a1_pin);
        m_id = getString(R.string.a1_id);
        maketext();
